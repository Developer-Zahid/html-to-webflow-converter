 ...
 */
export const DEFAULT_HTML = `<section class="hero-section main-class attribute:class sm:w-1/2 text-[14px]" style="padding: 60px 20px; background-color: #f3f4f6; border: 1px solid red; text-align: center;">
